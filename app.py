...
transcript = load_transcript('processed_transcript.json')  # Replace this with the correct file path
...
st.sidebar.title("Predefined Questions")
for question in predefined_questions:
    if st.sidebar.button(question):
        st.session_state.query = question

# Input text field
query = st.text_input("Ask a question from the ones mentioned above:", value=st.session_state.get('query', ''))
